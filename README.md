...
На данном этапе была изучена работа **Sysmon Event ID 1 (Process Creation)** — одного из наиболее важных событий в журнале Sysmon.

Было показано, что Splunk позволяет быстро находить события создания процессов, анализировать их содержимое и получать полную информацию о запущенных приложениях, пользователях, родительских процессах и параметрах запуска.

Именно с анализа подобных событий начинается расследование большинства инцидентов информационной безопасности в современных SOC.
